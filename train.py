...
from AttentionDE.executor import start_ddp_workers
...
def run(args):
    ...
    from AttentionDE import distrib
    from AttentionDE.data.data import Trainset, Validset
    from AttentionDE.models.swave_BiGRU import SWave
    from AttentionDE.solver import Solver
